...
<template>
  ...
  <div id="logo" style="opacity: 1; transform: translate(0px, 0px);">
          <!--?xml version="1.0" encoding="UTF-8" standalone="no"?-->
          <svg width="100%" height="100%" viewBox="0 0 500 150" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="
              fill-rule: evenodd;
              clip-rule: evenodd;
            ...
            <g>
              ...
              <path d="M295.381,105.999l-0,-43.063l-7.193,-0l-0,50.256l38.805,0l0,-7.193l-31.612,0Z" style="fill: #023047; fill-rule: nonzero"></path>
              <path d="M342.272,113.192l9.502,0l15.817,-28.582l-4.726,-8.622l-20.593,37.204Zm32.452,-41.464l-4.752,-8.584l-0.003,0.005l-4.747,8.579l22.948,41.464l9.504,0l-22.95,-41.464Z" style="fill: #023047; fill-rule: nonzero"></path>
